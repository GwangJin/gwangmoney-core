...
#if defined(NDEBUG)
# error "FairPay cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "FairPay Signed Message:\n";
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // FairPay: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // FairPay: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)

...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("FairPay Core fairpay-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  fairpay-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fairpay transaction") + "\n" +
              "  fairpay-tx [options] -create [commands]   " + _("Create hex-encoded fairpay transaction") + "\n" +
              "\n";
